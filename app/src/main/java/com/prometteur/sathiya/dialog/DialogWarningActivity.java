...
import static com.prometteur.sathiya.utills.AppMethods.showProgress;
    ...
    public class DialogWarningActivity extends BaseActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            prefUpdate = PreferenceManager.getDefaultSharedPreferences(com.prometteur.sathiya.dialog.DialogWarningActivity.this);
        ...
        {
            progresDialog=showProgress(com.prometteur.sathiya.dialog.DialogWarningActivity.this);
                ...
                protected void onPostExecute(String result)
                {
                    ...
                    try
                    {
                        ...
                        if(status.equalsIgnoreCase("1"))
                        {
                            ...
                            setToastStr(com.prometteur.sathiya.dialog.DialogWarningActivity.this,message);
                        ...
                        }else
                        {
                            ...
                            String message=obj.getString("message");
                            AlertDialog.Builder builder = new AlertDialog.Builder(com.prometteur.sathiya.dialog.DialogWarningActivity.this);
