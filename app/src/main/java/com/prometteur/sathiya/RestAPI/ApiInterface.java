package com.prometteur.sathiya.RestAPI;


import com.prometteur.sathiya.RoboPOJO.ProfileManagePhotoResponse;
import com.prometteur.sathiya.RoboPOJO.ProfileUpdateResponse;
...
public interface ApiInterface {
    ...
    @Multipart
    @POST("add_interest_photo.php")
    public Call<ProfileManagePhotoResponse> postManagePhotoHobby(
            @Part("matri_id") RequestBody user_id,
            @Part("hoby_id") RequestBody hoby_id,
            @Part MultipartBody.Part image,
