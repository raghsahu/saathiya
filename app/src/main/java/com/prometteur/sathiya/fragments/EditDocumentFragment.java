...
public class EditDocumentFragment extends Fragment {
    ...
    int position;
    String strFilePath = "";
    public static String TAG="EditDocumentFragment";
    ...
    FragmentEditDocumentBinding documentBinding;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        documentBinding=FragmentEditDocumentBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        documentBinding.tvBackClick.setOnClickListener(new View.OnClickListener() {
            @Override
                    ...
                    imgEdit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            CropImage.activity()
                                    ...
                                    .start(getActivity(),EditDocumentFragment.this);
                        }
                    });
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                if (!strFilePath.equalsIgnoreCase("")) {
                    ...
                    Toast.makeText(getActivity(), "Please select profile picture.", Toast.LENGTH_LONG).show();
                }
